                        ...
                        $asso_err=false;
                                ...
                                if(isset($columns['END_DATE'])){
                                 ...
                                 $days=floor((strtotime($check1,0)-strtotime($check,0))/86400); 
                                        ...
                                        {
                                            $err_msg='Data not saved because title can not be blank';
                                            $error=true;
                                        }
                                        if(array_key_exists('SHORT_NAME', $columns) && trim($columns['SHORT_NAME']==''))
                                        {
                                            $err_msg='Data not saved because short name can not be blank';
                                            $error=true;
                                        }
...
//                                                           
                                                                if($value!='')
                                                                {
                                                                    ...
                                                                    {
                                                                        $err_msg="Grade Posting Begins date can not occur after the Marking Period End date";
                                                                        break 2;
                                                                    }
